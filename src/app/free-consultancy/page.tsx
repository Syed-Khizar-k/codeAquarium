...
export const metadata: Metadata = pageMeta({
 ...
 description:
  "Book a free 30-minute strategy consultation with Code Aquarium Technologies. Pick a date and time in your own timezone — we'll map the fastest path from your idea to launch. No cost, no obligation.",
   ...
   <JsonLd
    schema={[
     webPageSchema({
      ...
      description:
       "Book a free 30-minute strategy consultation with Code Aquarium Technologies.",
     }),
     consultationOfferSchema(),
     breadcrumbSchema([
      { name: "Home", path: "/" },
