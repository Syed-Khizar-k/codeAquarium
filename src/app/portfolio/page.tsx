...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "Real solutions, real results. See how Code Aquarium builds web apps, SaaS, AI platforms, and telehealth products — with measurable gains in speed, conversion, and uptime.",
  path: "/portfolio",
  keywords: [
