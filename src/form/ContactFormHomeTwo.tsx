    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        const tokenResponse = await axios.get(
          "https://mgtd_dev_v1.lndo.site:8080/session/token"
        );
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="form-box user-icon mb-30">
              ...
              {formik.touched.name && formik.errors.name && (
                <p className="text-danger text-sm">{formik.errors.name}</p>
              )}
            </div>
          </div>
          <div className="col-lg-6">
          ...
          <div className="col-lg-12 mb-4">
            <select
              ...
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className="form-select w-100 p-3 bg-transparent"
            >
              ...
              />
              <option value="Digital Marketing" label="Digital Marketing" />
            ...
            {formik.touched.subject && formik.errors.subject && (
              <p className="text-danger text-sm">{formik.errors.subject}</p>
            )}
          </div>
