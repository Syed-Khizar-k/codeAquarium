...
export const homeFaqs: QA[] = [
  {
    q: "What does Code Aquarium do?",
    a: "Code Aquarium is a digital studio that builds custom software, AI systems, and growth engines. Our services span web development, artificial intelligence and automation, digital marketing and SEO, DevOps and cloud, data engineering, and UX/UI design — everything a startup or established brand needs to design, build, and scale a digital product.",
  },
  {
    q: "Where is Code Aquarium based, and do you work with international clients?",
    a: "Code Aquarium is headquartered in Lahore, Pakistan, and works with clients worldwide. We collaborate remotely with startups and companies across North America, Europe, the Middle East, and Australia, with overlapping working hours and clear async communication.",
  },
  {
  ...
  {
    q: "What technologies does Code Aquarium use?",
...
export const serviceFaqs: Record<string, QA[]> = {
  "web-development": [
    {
      q: "What web development services does Code Aquarium offer?",
  ...
  "artificial-intelligence": [
    {
      q: "What AI services does Code Aquarium provide?",
  ...
  "devops-cloud": [
    {
      q: "What DevOps and cloud services does Code Aquarium offer?",
