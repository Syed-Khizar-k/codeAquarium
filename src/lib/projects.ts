...
export const projects: Project[] = [
  {
    slug: "reefside-marketplace",
    title: "Reefside Marketplace",
    tag: "Web Development",
    logoInitials: "RM",
    excerpt:
      "A regional classifieds and community platform serving properties, vehicles, jobs, and local news to hundreds of thousands of monthly users.",
    summary:
