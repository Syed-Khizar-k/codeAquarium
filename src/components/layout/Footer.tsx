      ...
      <div className="max-w-page mx-auto px-5 py-14 md:px-20 lg:px-32 md:py-16">
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
            ...
            <div>
              ...
              <form action="/contact" className="relative max-w-sm">
                ...
                <button
                  ...
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-ocean-600 hover:bg-ocean-500 p-2.5 transition-colors"
                >
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:gap-16">
            <div>
              <h2 className="text-white/50 uppercase tracking-wider text-sm mb-4">Explore</h2>
              <ul className="flex flex-col gap-2.5">
                {footerNav.explore.map((l) => (
                  <li key={l.href}>
                    <Link href={l.href} className="text-white/75 hover:text-ocean-300 transition-colors">
                      {l.label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              <h2 className="text-white/50 uppercase tracking-wider text-sm mb-4">Legal</h2>
              <ul className="flex flex-col gap-2.5">
            ...
            <div className="col-span-2 sm:col-span-1">
              <h2 className="text-white/50 uppercase tracking-wider text-sm mb-4">Contact</h2>
              <ul className="flex flex-col gap-2.5">
                <li>
                  <a href={`tel:${site.phoneHref}`} className="text-white/75 hover:text-ocean-300 transition-colors">
                    {site.phone}
                  </a>
                </li>
                <li>
                  <a href={`mailto:${site.email}`} className="text-white/75 hover:text-ocean-300 transition-colors">
                    {site.email}
                  </a>
                </li>
